        ...
        <div>
            ...
            <div className='flex flex-col items-center justify-center mt-10'>
                ...
                <form className='flex flex-col gap-4 mt-10'>
                    ...
                    <Dropdown label={''} name={selectedOption} options={['Administrador', 'Gestor de promociones', 'Lector']} value={selectedOption} onChange={(e) => setSelectedOption(e.target.value)} ></Dropdown>
